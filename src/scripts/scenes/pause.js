class Pause extends Phaser.Scene {
  ...
  create() {
    ...
    let quitBtn = this.add.image((config.width / 2), (config.height / 2 + 100), "quit").setScale(0.5);

    let continueBtn = this.add.image(config.width / 2, (config.height / 2 - 50), "continue").setScale(0.5);
